<template>
    <MainLayout>
        <VPageHero
            ...
            title="Сведения и документы Ассоциации"
            subtitle="Информация об Ассоциации, органах управления, документах и отчётах о деятельности. Сведения будут дополнены после предоставления и утверждения официальных документов."
        />
