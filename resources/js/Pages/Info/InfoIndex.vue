<template>
    <MainLayout>
        <VPageHero
            ...
            subtitle="Обязательные сведения о деятельности: документы, структура и органы управления, образование, материально-техническое обеспечение и условия обучения."
        />
