<template>
    <MainLayout>
        <VPageHero
            ...
            title="Профессиональная повестка кофейной и чайной индустрии"
            subtitle="Новости Ассоциации, проекты профессиональных стандартов, образование и аккредитация, регулирование, отраслевые события, исследования и международные практики."
        />
        <VContentSection alt>
