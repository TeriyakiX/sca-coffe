...
final class PartnerCreateRequest extends FormRequest
{
    ...
    public final function rules(): array
    {
        return [
            ...
            'slug' => ['required', 'string', 'between:2,255', 'alpha_dash', Rule::unique(Partner::DATABASE_TABLE, Partner::SLUG)],
            'category' => ['required', 'string', new Enum(PartnerCategoryEnum::class)],
    ...
    public final function toDto(): PartnerCreateDto
    {
